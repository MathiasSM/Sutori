...
type SutMonad a = StateT SutState (WriterT SutParserLog (Either SutParserError)) a
...
parserCurScope = head . parserStack
...
-- Regular Actions
---------------------------------------------------------------------------------------------------
runMonad :: SutMonad a -> SutParserState -> Either SutParserError ((a, SutParserState), SutParserLog)
